        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamOneId = table.Column<string>(nullable: true),
                    TeamTwoId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BioMeasures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BioMeasures_Players_PlayerId",
                        column: x => x.PlayerId,
